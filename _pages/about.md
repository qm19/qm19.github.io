...
- <span style="background-color: #191970; color: white; padding: 1px; border-radius: 1px;">IEEE Transactions on Reliability</span> [A Weakly Supervised Learning-Based Oversampling Framework for Class-Imbalanced Fault Diagnosis](https://ieeexplore.ieee.org/document/9677063), **Min Qian**, Yan-Fu Li (**IF=5.9**)
- <span style="background-color: #191970; color: white; padding: 1px; border-radius: 1px;">IEEE Transactions on Instrumentation and Measurement</span> [Energy Saving Scheduling of A Single Machine System Based on Bi-objective Particle Swarm Optimization](https://ieeexplore.ieee.org/document/9677063), Te Han, Yan-Fu Li, **Min Qian** (**IF=5.6, High citation**)
